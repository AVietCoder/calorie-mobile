...
// Plus mobile-specific keys appended at the bottom of each block.
  export const DICT = {
    vi: {
      ...
      "ml.back_personal": "Thực đơn cá nhân",
    ...
    en: {
      ...
      /* ----- Cài đặt & xoá tài khoản (Google Play) ----- */
      "set.title": "Settings",
      "set.account": "Account",
      ...
      "set.confirm_body": "Deleting your account is permanent. Your profile, nutrition information, meal history, food photos, AI conversation history and personal settings will be deleted.\n\nThis action cannot be undone.",
      ...
      "set.err_offline": "No internet connection. Reconnect and try again — your account has not been changed.",
      "set.err_generic": "Could not delete your account. Please try again.",
      ...
      "set.delete_more_m": "Account deletion is normally completed immediately. Storage backups may take up to 30 days to expire.",
      "m.back": "Back",
      "m.cancel": "Cancel",
    },
  };
