...
const EXTRA = {
  vi: {
    ...
    'm.perm_cam': 'Dr.Fit cần quyền dùng camera để chụp món ăn.',
    'm.perm_lib': 'Dr.Fit cần quyền truy cập ảnh để bạn chọn món ăn cần phân tích.',
    'm.add_photo_title': 'Thêm ảnh món ăn',
    'm.add_photo_q': 'Bạn muốn lấy ảnh từ đâu?',
    'm.take_photo': 'Chụp ảnh',
    ...
    'm.invalid_birth_year': 'Năm sinh không hợp lệ.',
    'm.invalid_height': 'Chiều cao phải nằm trong khoảng 80 - 250 cm.',
    'm.invalid_weight': 'Cân nặng phải nằm trong khoảng 20 - 300 kg.',
    ...
    'm.guide_sub': 'Mọi thứ bạn cần biết để dùng Dr.Fit hiệu quả',
    ...
    /* Trợ lý giọng nói (voice health agent) */
    'assistant.listening': 'Đang nghe…',
    'assistant.thinking': 'Đang xử lý…',
    'assistant.speaking': 'Đang trả lời…',
    'assistant.say_something': 'Hãy nói điều bạn muốn…',
    'assistant.tap_to_talk': 'Chạm để nói',
    'assistant.ask_meal_time': 'Bạn ăn món này vào bữa nào — sáng, trưa, tối hay bữa phụ?',
    'assistant.ask_meal_time_retry': 'Bạn ăn vào bữa nào — sáng, trưa, tối hay bữa phụ?',
    'assistant.done': 'Đã xong.',
    'assistant.error': 'Xin lỗi, mình gặp chút lỗi. Bạn thử lại nhé.',
    /* Trợ lý — hành động (Phase 2) */
    'assistant.navigated': 'Đã mở {tab} cho bạn.',
    'assistant.nav_fail': 'Xin lỗi, mình chưa mở được mục đó.',
    'assistant.reminder_set': 'Đã đặt nhắc "{label}" lúc {time}.',
    'assistant.reminder_no_time': 'Bạn muốn nhắc vào lúc mấy giờ?',
    'assistant.calories_left': 'Bạn còn {n} calo cho hôm nay.',
    'assistant.calories_over': 'Bạn đã vượt {n} calo hôm nay.',
    'assistant.macro_status': 'Hôm nay bạn đã nạp {have} trên {target} gam {macro}.',
    'assistant.no_intake': 'Hôm nay bạn chưa ghi bữa nào. Hãy tick "Đã ăn" ở Kế hoạch hoặc kể cho mình món bạn đã ăn.',
    'assistant.plan_regen': 'Đã tạo thực đơn mới cho bạn.',
    'assistant.plan_regen_valid': 'Thực đơn tuần này vẫn còn hiệu lực nên mình chưa tạo mới.',
    'assistant.profile_updated': 'Đã cập nhật {field} thành {value}.',
    'assistant.profile_bad': 'Giá trị đó có vẻ chưa hợp lệ.',
    /* Trợ lý — rảnh tay / wake word (Phase 3) */
    'assistant.wake_armed': 'Đang nghe "Hey Calorie"',
    'assistant.wake_on': 'Đã bật chế độ rảnh tay. Hãy nói "Hey Calorie".',
    'assistant.wake_off': 'Đã tắt chế độ rảnh tay.',
    'assistant.wake_unavailable': 'Chế độ rảnh tay cần cấu hình Picovoice (xem README).',
    /* Nhắc uống nước */
    'rem.tab_water': 'Uống nước',
    'rem.fire_water': '💧 Đến giờ uống nước',
    'rem.alarm_default_water': 'Hãy uống một cốc nước nhé.',
    'rem.label_water_ph': 'VD: Uống 1 cốc nước',
  },
  en: {
    ...
    'm.perm_cam': 'Dr.Fit needs camera access to take a photo of your food.',
    'm.perm_lib': 'Dr.Fit needs photo access so you can pick a dish to analyze.',
    'm.add_photo_title': 'Add a food photo',
    ...
    'm.invalid_birth_year': 'Invalid birth year.',
    'm.invalid_height': 'Height must be between 80 and 250 cm.',
    'm.invalid_weight': 'Weight must be between 20 and 300 kg.',
    ...
    'm.guide_sub': 'Everything you need to use Dr.Fit effectively',
    ...
    'assistant.say_something': 'Say what you need…',
    'assistant.tap_to_talk': 'Tap to talk',
    'assistant.ask_meal_time': 'Which meal was this — breakfast, lunch, dinner or a snack?',
    'assistant.ask_meal_time_retry': 'Which meal was it — breakfast, lunch, dinner or a snack?',
    'assistant.done': 'Done.',
    'assistant.error': 'Sorry, something went wrong. Please try again.',
    /* Assistant — actions (Phase 2) */
    'assistant.navigated': 'Opening {tab}.',
    'assistant.nav_fail': "Sorry, I couldn't open that.",
    'assistant.reminder_set': 'Reminder set: "{label}" at {time}.',
    'assistant.reminder_no_time': 'What time should I remind you?',
    'assistant.calories_left': 'You have {n} calories left today.',
    'assistant.calories_over': "You're {n} calories over today.",
    'assistant.macro_status': 'Today you have had {have} of {target} grams of {macro}.',
    'assistant.no_intake': 'You have not logged any meals today. Tick "Eaten" on the Plan tab, or tell me what you ate.',
    'assistant.plan_regen': 'I created a new meal plan for you.',
    'assistant.plan_regen_valid': "This week's plan is still valid, so I didn't regenerate it.",
    'assistant.profile_updated': 'Updated {field} to {value}.',
    'assistant.profile_bad': "That value doesn't look right.",
    /* Assistant — hands-free / wake word (Phase 3) */
    'assistant.wake_armed': 'Listening for "Hey Calorie"',
    'assistant.wake_on': 'Hands-free on. Say "Hey Calorie".',
    'assistant.wake_off': 'Hands-free off.',
    'assistant.wake_unavailable': 'Hands-free needs Picovoice setup (see README).',
    /* Water reminder */
    'rem.tab_water': 'Water',
    'rem.fire_water': '💧 Time to drink water',
    'rem.alarm_default_water': 'Take a moment to drink some water.',
    'rem.label_water_ph': 'e.g. Drink a glass of water',
  },
};
